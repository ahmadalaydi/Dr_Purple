...
[NotAuditable]
public partial class ServiceProviderSubDepartmentMaterial : ISubDepartmentMaterial
{
    ...
    protected ServiceProviderSubDepartmentMaterial(long subDepartmentId, long materialId, float quantity)
    {
    ...
    public static ServiceProviderSubDepartmentMaterial Create(long subDepartmentId, long materialId, float quantity)
