...
internal sealed class NotForSaleOrderItemConfig : IEntityTypeConfiguration<NotForSaleOrderItem>
{
    public void Configure(EntityTypeBuilder<NotForSaleOrderItem> builder)
    {
