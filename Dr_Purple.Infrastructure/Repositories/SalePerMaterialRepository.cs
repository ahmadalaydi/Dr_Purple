...
public class SalePerMaterialRepository : BaseRepository<SalePerMaterial>, ISalePerMaterialRepository
{
    public SalePerMaterialRepository(AppDbContext dbContext) : base(dbContext) { }
}
