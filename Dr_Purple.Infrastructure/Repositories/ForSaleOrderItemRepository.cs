...
public class ForSaleOrderItemRepository : BaseRepository<ForSaleOrderItem>, IForSaleOrderItemRepository
{
    public ForSaleOrderItemRepository(AppDbContext dbContext) : base(dbContext) { }
}
