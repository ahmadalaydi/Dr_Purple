...
public class GetFirstContractQueryHandler : BaseContractQueryHandler,
    IRequestHandler<GetFirstContractQuery, IDataResult<ContractResponse>>
{
    public GetFirstContractQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ContractResponse>> Handle(GetFirstContractQuery? request, CancellationToken cancellationToken)
    {
