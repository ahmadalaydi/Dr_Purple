...
public class GetAllContractQueryHandler : BaseContractQueryHandler,
    IRequestHandler<GetAllContractQuery, IDataResult<ContractResponse>>
{
    public GetAllContractQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ContractResponse>> Handle(GetAllContractQuery? request, CancellationToken cancellationToken)
    {
