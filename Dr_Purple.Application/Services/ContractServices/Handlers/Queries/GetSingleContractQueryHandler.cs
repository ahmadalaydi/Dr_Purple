...
public class GetSingleContractQueryHandler : BaseContractQueryHandler,
    IRequestHandler<GetSingleContractQuery, IDataResult<ContractResponse>>
{
    public GetSingleContractQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ContractResponse>> Handle(GetSingleContractQuery? request, CancellationToken cancellationToken)
    {
