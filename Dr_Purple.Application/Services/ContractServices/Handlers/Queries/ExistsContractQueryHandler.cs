...
public class ExistsContractQueryHandler : BaseContractQueryHandler,
    IRequestHandler<ExistsContractQuery, IDataResult<ContractResponse>>
{
    public ExistsContractQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ContractResponse>> Handle(ExistsContractQuery? request, CancellationToken cancellationToken)
    {
