...
public class ExistsAppointmentQueryHandler : BaseAppointmentQueryHandler,
    IRequestHandler<ExistsAppointmentQuery, IDataResult<AppointmentResponse>>
{
    public ExistsAppointmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AppointmentResponse>> Handle(ExistsAppointmentQuery? request, CancellationToken cancellationToken)
    {
