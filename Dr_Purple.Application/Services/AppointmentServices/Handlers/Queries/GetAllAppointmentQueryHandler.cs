...
public class GetAllAppointmentQueryHandler : BaseAppointmentQueryHandler,
    IRequestHandler<GetAllAppointmentQuery, IDataResult<AppointmentResponse>>
{
    public GetAllAppointmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AppointmentResponse>> Handle(GetAllAppointmentQuery? request, CancellationToken cancellationToken)
    {
