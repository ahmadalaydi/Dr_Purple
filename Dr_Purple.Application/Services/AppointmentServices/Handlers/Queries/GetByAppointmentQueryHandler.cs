...
public class GetByAppointmentQueryHandler : BaseAppointmentQueryHandler,
    IRequestHandler<GetByAppointmentQuery, IDataResult<AppointmentResponse>>
{
    public GetByAppointmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AppointmentResponse>> Handle(GetByAppointmentQuery? request, CancellationToken cancellationToken)
    {
