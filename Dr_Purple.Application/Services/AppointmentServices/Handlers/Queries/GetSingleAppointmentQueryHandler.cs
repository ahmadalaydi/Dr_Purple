...
public class GetSingleAppointmentQueryHandler : BaseAppointmentQueryHandler,
    IRequestHandler<GetSingleAppointmentQuery, IDataResult<AppointmentResponse>>
{
    public GetSingleAppointmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AppointmentResponse>> Handle(GetSingleAppointmentQuery? request, CancellationToken cancellationToken)
    {
