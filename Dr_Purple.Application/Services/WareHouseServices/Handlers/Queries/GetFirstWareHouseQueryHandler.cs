...
public class GetFirstWareHouseQueryHandler : BaseWareHouseQueryHandler,
    IRequestHandler<GetFirstWareHouseQuery, IDataResult<WareHouseResponse>>
{
    public GetFirstWareHouseQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<WareHouseResponse>> Handle(GetFirstWareHouseQuery? request, CancellationToken cancellationToken)
    {
