...
namespace Dr_Purple.Application.Services.WareHouseServices.Handlers.Queries.Base;
public class BaseWareHouseQueryHandler : BaseHandler
{
    protected internal IWareHouseRepository? Repository;
    public BaseWareHouseQueryHandler(IServiceProvider? provider)
