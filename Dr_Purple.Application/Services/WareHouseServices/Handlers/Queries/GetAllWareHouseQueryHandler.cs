...
public class GetAllWareHouseQueryHandler : BaseWareHouseQueryHandler,
    IRequestHandler<GetAllWareHouseQuery, IDataResult<WareHouseResponse>>
{
    public GetAllWareHouseQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<WareHouseResponse>> Handle(GetAllWareHouseQuery? request, CancellationToken cancellationToken)
    {
