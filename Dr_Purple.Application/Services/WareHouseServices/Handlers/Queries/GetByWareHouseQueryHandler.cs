...
public class GetByWareHouseQueryHandler : BaseWareHouseQueryHandler,
    IRequestHandler<GetByWareHouseQuery, IDataResult<WareHouseResponse>>
{
    public GetByWareHouseQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<WareHouseResponse>> Handle(GetByWareHouseQuery? request, CancellationToken cancellationToken)
    {
