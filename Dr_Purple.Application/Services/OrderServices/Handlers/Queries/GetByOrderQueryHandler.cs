...
public class GetByOrderQueryHandler : BaseOrderQueryHandler,
    IRequestHandler<GetByOrderQuery, IDataResult<OrderResponse>>
{
    public GetByOrderQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OrderResponse>> Handle(GetByOrderQuery? request, CancellationToken cancellationToken)
    {
