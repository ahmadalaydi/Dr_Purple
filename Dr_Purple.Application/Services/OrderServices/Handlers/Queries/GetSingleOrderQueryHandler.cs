...
public class GetSingleOrderQueryHandler : BaseOrderQueryHandler,
    IRequestHandler<GetSingleOrderQuery, IDataResult<OrderResponse>>
{
    public GetSingleOrderQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OrderResponse>> Handle(GetSingleOrderQuery? request, CancellationToken cancellationToken)
    {
