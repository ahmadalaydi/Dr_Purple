...
public class GetAllOrderQueryHandler : BaseOrderQueryHandler,
    IRequestHandler<GetAllOrderQuery, IDataResult<OrderResponse>>
{
    public GetAllOrderQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OrderResponse>> Handle(GetAllOrderQuery? request, CancellationToken cancellationToken)
    {
