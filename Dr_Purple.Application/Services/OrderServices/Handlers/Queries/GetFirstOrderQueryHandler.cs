...
public class GetFirstOrderQueryHandler : BaseOrderQueryHandler,
    IRequestHandler<GetFirstOrderQuery, IDataResult<OrderResponse>>
{
    public GetFirstOrderQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OrderResponse>> Handle(GetFirstOrderQuery? request, CancellationToken cancellationToken)
    {
