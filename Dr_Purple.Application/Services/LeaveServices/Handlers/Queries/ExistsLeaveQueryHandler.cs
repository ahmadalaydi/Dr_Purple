...
public class ExistsLeaveQueryHandler : BaseLeaveQueryHandler,
    IRequestHandler<ExistsLeaveQuery, IDataResult<LeaveResponse>>
{
    public ExistsLeaveQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<LeaveResponse>> Handle(ExistsLeaveQuery? request, CancellationToken cancellationToken)
    {
