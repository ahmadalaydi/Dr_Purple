...
public class GetSingleLeaveQueryHandler : BaseLeaveQueryHandler,
    IRequestHandler<GetSingleLeaveQuery, IDataResult<LeaveResponse>>
{
    public GetSingleLeaveQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<LeaveResponse>> Handle(GetSingleLeaveQuery? request, CancellationToken cancellationToken)
    {
