...
public class GetFirstLeaveQueryHandler : BaseLeaveQueryHandler,
    IRequestHandler<GetFirstLeaveQuery, IDataResult<LeaveResponse>>
{
    public GetFirstLeaveQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<LeaveResponse>> Handle(GetFirstLeaveQuery? request, CancellationToken cancellationToken)
    {
