...
public class GetAllLeaveQueryHandler : BaseLeaveQueryHandler,
    IRequestHandler<GetAllLeaveQuery, IDataResult<LeaveResponse>>
{
    public GetAllLeaveQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<LeaveResponse>> Handle(GetAllLeaveQuery? request, CancellationToken cancellationToken)
    {
