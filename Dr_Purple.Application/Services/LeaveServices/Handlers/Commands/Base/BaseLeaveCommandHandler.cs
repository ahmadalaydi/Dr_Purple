...
namespace Dr_Purple.Application.Services.LeaveServices.Handlers.Commands.Base;
public class BaseLeaveCommandHandler : BaseHandler
{
    protected internal ILeaveRepository? Repository;
    public BaseLeaveCommandHandler(IServiceProvider? provider)
