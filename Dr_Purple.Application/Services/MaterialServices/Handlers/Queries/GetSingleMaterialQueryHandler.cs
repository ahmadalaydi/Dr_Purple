...
public class GetSingleMaterialQueryHandler : BaseMaterialQueryHandler,
    IRequestHandler<GetSingleMaterialQuery, IDataResult<MaterialResponse>>
{
    public GetSingleMaterialQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<MaterialResponse>> Handle(GetSingleMaterialQuery? request, CancellationToken cancellationToken)
    {
