...
public class GetFirstMaterialQueryHandler : BaseMaterialQueryHandler,
    IRequestHandler<GetFirstMaterialQuery, IDataResult<MaterialResponse>>
{
    public GetFirstMaterialQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<MaterialResponse>> Handle(GetFirstMaterialQuery? request, CancellationToken cancellationToken)
    {
