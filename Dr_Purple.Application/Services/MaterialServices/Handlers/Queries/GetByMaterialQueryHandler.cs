...
public class GetByMaterialQueryHandler : BaseMaterialQueryHandler,
    IRequestHandler<GetByMaterialQuery, IDataResult<MaterialResponse>>
{
    public GetByMaterialQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<MaterialResponse>> Handle(GetByMaterialQuery? request, CancellationToken cancellationToken)
    {
