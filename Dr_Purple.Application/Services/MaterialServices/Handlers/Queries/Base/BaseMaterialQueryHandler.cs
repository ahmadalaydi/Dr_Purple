...
namespace Dr_Purple.Application.Services.MaterialServices.Handlers.Queries.Base;
public class BaseMaterialQueryHandler : BaseHandler
{
    protected internal IMaterialRepository? Repository;
    public BaseMaterialQueryHandler(IServiceProvider? provider)
