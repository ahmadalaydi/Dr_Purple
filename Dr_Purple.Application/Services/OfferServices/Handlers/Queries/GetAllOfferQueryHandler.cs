...
public class GetAllOfferQueryHandler : BaseOfferQueryHandler,
    IRequestHandler<GetAllOfferQuery, IDataResult<OfferResponse>>
{
    public GetAllOfferQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OfferResponse>> Handle(GetAllOfferQuery? request, CancellationToken cancellationToken)
    {
