...
public class GetByOfferQueryHandler : BaseOfferQueryHandler,
    IRequestHandler<GetByOfferQuery, IDataResult<OfferResponse>>
{
    public GetByOfferQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OfferResponse>> Handle(GetByOfferQuery? request, CancellationToken cancellationToken)
    {
