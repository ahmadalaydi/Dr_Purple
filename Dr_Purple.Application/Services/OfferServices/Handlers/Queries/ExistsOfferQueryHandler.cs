...
public class ExistsOfferQueryHandler : BaseOfferQueryHandler,
    IRequestHandler<ExistsOfferQuery, IDataResult<OfferResponse>>
{
    public ExistsOfferQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<OfferResponse>> Handle(ExistsOfferQuery? request, CancellationToken cancellationToken)
    {
