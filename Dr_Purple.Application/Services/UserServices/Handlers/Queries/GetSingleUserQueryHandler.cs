...
public class GetSingleUserQueryHandler : BaseUserQueryHandler,
    IRequestHandler<GetSingleUserQuery, IDataResult<UserResponse>>
{
    public GetSingleUserQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UserResponse>> Handle(GetSingleUserQuery? request, CancellationToken cancellationToken)
    {
