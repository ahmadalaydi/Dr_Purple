...
public class GetByUserQueryHandler : BaseUserQueryHandler,
    IRequestHandler<GetByUserQuery, IDataResult<UserResponse>>
{
    public GetByUserQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UserResponse>> Handle(GetByUserQuery? request, CancellationToken cancellationToken)
    {
