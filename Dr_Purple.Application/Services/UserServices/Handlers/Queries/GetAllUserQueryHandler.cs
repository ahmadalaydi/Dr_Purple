...
public class GetAllUserQueryHandler : BaseUserQueryHandler,
    IRequestHandler<GetAllUserQuery, IDataResult<UserResponse>>
{
    public GetAllUserQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UserResponse>> Handle(GetAllUserQuery? request, CancellationToken cancellationToken)
    {
