...
public class GetAllDepartmentQueryHandler : BaseDepartmentQueryHandler,
    IRequestHandler<GetAllDepartmentQuery, IDataResult<DepartmentResponse>>
{
    public GetAllDepartmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<DepartmentResponse>> Handle(GetAllDepartmentQuery? request, CancellationToken cancellationToken)
    {
