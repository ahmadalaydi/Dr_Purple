...
public class ExistsDepartmentQueryHandler : BaseDepartmentQueryHandler,
    IRequestHandler<ExistsDepartmentQuery, IDataResult<DepartmentResponse>>
{
    public ExistsDepartmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<DepartmentResponse>> Handle(ExistsDepartmentQuery? request, CancellationToken cancellationToken)
    {
