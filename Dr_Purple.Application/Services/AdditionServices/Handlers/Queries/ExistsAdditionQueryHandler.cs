...
public class ExistsAdditionQueryHandler : BaseAdditionQueryHandler,
    IRequestHandler<ExistsAdditionQuery, IDataResult<AdditionResponse>>
{
    public ExistsAdditionQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AdditionResponse>> Handle(ExistsAdditionQuery? request, CancellationToken cancellationToken)
    {
