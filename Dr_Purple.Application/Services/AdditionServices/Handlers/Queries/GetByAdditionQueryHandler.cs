...
public class GetByAdditionQueryHandler : BaseAdditionQueryHandler,
    IRequestHandler<GetByAdditionQuery, IDataResult<AdditionResponse>>
{
    public GetByAdditionQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AdditionResponse>> Handle(GetByAdditionQuery? request, CancellationToken cancellationToken)
    {
