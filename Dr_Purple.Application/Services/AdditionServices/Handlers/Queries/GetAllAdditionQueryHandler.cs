...
public class GetAllAdditionQueryHandler : BaseAdditionQueryHandler,
    IRequestHandler<GetAllAdditionQuery, IDataResult<AdditionResponse>>
{
    public GetAllAdditionQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AdditionResponse>> Handle(GetAllAdditionQuery? request, CancellationToken cancellationToken)
    {
