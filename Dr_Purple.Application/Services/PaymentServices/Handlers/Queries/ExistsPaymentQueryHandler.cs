...
public class ExistsPaymentQueryHandler : BasePaymentQueryHandler,
    IRequestHandler<ExistsPaymentQuery, IDataResult<PaymentResponse>>
{
    public ExistsPaymentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<PaymentResponse>> Handle(ExistsPaymentQuery? request, CancellationToken cancellationToken)
    {
