...
public class GetByPaymentQueryHandler : BasePaymentQueryHandler,
    IRequestHandler<GetByPaymentQuery, IDataResult<PaymentResponse>>
{
    public GetByPaymentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<PaymentResponse>> Handle(GetByPaymentQuery? request, CancellationToken cancellationToken)
    {
