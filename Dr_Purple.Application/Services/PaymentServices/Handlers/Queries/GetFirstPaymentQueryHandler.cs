...
public class GetFirstPaymentQueryHandler : BasePaymentQueryHandler,
    IRequestHandler<GetFirstPaymentQuery, IDataResult<PaymentResponse>>
{
    public GetFirstPaymentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<PaymentResponse>> Handle(GetFirstPaymentQuery? request, CancellationToken cancellationToken)
    {
