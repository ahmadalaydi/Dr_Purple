...
public class GetSingleAttendQueryHandler : BaseAttendQueryHandler,
    IRequestHandler<GetSingleAttendQuery, IDataResult<AttendResponse>>
{
    public GetSingleAttendQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AttendResponse>> Handle(GetSingleAttendQuery? request, CancellationToken cancellationToken)
    {
