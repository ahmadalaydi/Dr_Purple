...
public class GetByAttendQueryHandler : BaseAttendQueryHandler,
    IRequestHandler<GetByAttendQuery, IDataResult<AttendResponse>>
{
    public GetByAttendQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AttendResponse>> Handle(GetByAttendQuery? request, CancellationToken cancellationToken)
    {
