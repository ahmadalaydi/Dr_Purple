...
public class GetFirstAttendQueryHandler : BaseAttendQueryHandler,
    IRequestHandler<GetFirstAttendQuery, IDataResult<AttendResponse>>
{
    public GetFirstAttendQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AttendResponse>> Handle(GetFirstAttendQuery? request, CancellationToken cancellationToken)
    {
