...
public class GetAllAttendQueryHandler : BaseAttendQueryHandler,
    IRequestHandler<GetAllAttendQuery, IDataResult<AttendResponse>>
{
    public GetAllAttendQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<AttendResponse>> Handle(GetAllAttendQuery? request, CancellationToken cancellationToken)
    {
