...
public class GetBySubDepartmentQueryHandler : BaseSubDepartmentQueryHandler,
    IRequestHandler<GetBySubDepartmentQuery, IDataResult<SubDepartmentResponse>>
{
    public GetBySubDepartmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<SubDepartmentResponse>> Handle(GetBySubDepartmentQuery? request, CancellationToken cancellationToken)
    {
