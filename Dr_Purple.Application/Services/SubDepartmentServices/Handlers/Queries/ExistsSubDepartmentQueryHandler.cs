...
public class ExistsSubDepartmentQueryHandler : BaseSubDepartmentQueryHandler,
    IRequestHandler<ExistsSubDepartmentQuery, IDataResult<SubDepartmentResponse>>
{
    public ExistsSubDepartmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<SubDepartmentResponse>> Handle(ExistsSubDepartmentQuery? request, CancellationToken cancellationToken)
    {
