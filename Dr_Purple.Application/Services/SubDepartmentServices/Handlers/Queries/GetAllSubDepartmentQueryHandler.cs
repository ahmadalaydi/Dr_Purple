...
public class GetAllSubDepartmentQueryHandler : BaseSubDepartmentQueryHandler,
    IRequestHandler<GetAllSubDepartmentQuery, IDataResult<SubDepartmentResponse>>
{
    public GetAllSubDepartmentQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<SubDepartmentResponse>> Handle(GetAllSubDepartmentQuery? request, CancellationToken cancellationToken)
    {
