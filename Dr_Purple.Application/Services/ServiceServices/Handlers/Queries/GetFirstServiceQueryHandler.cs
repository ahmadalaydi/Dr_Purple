...
public class GetFirstServiceQueryHandler : BaseServiceQueryHandler,
    IRequestHandler<GetFirstServiceQuery, IDataResult<ServiceResponse>>
{
    public GetFirstServiceQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ServiceResponse>> Handle(GetFirstServiceQuery? request, CancellationToken cancellationToken)
    {
