...
public class GetSingleServiceQueryHandler : BaseServiceQueryHandler,
    IRequestHandler<GetSingleServiceQuery, IDataResult<ServiceResponse>>
{
    public GetSingleServiceQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ServiceResponse>> Handle(GetSingleServiceQuery? request, CancellationToken cancellationToken)
    {
