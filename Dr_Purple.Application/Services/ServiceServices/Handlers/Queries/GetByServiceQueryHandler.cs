...
public class GetByServiceQueryHandler : BaseServiceQueryHandler,
    IRequestHandler<GetByServiceQuery, IDataResult<ServiceResponse>>
{
    public GetByServiceQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<ServiceResponse>> Handle(GetByServiceQuery? request, CancellationToken cancellationToken)
    {
