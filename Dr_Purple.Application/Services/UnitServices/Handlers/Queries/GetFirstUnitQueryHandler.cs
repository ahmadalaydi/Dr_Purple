...
public class GetFirstUnitQueryHandler : BaseUnitQueryHandler,
    IRequestHandler<GetFirstUnitQuery, IDataResult<UnitResponse>>
{
    public GetFirstUnitQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UnitResponse>> Handle(GetFirstUnitQuery? request, CancellationToken cancellationToken)
    {
