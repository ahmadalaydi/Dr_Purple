...
public class GetByUnitQueryHandler : BaseUnitQueryHandler,
    IRequestHandler<GetByUnitQuery, IDataResult<UnitResponse>>
{
    public GetByUnitQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UnitResponse>> Handle(GetByUnitQuery? request, CancellationToken cancellationToken)
    {
