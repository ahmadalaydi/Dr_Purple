...
public class GetSingleUnitQueryHandler : BaseUnitQueryHandler,
    IRequestHandler<GetSingleUnitQuery, IDataResult<UnitResponse>>
{
    public GetSingleUnitQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UnitResponse>> Handle(GetSingleUnitQuery? request, CancellationToken cancellationToken)
    {
