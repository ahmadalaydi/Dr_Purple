...
public class ExistsUnitQueryHandler : BaseUnitQueryHandler,
    IRequestHandler<ExistsUnitQuery, IDataResult<UnitResponse>>
{
    public ExistsUnitQueryHandler(IServiceProvider provider) : base(provider) { }

    public async Task<IDataResult<UnitResponse>> Handle(ExistsUnitQuery? request, CancellationToken cancellationToken)
    {
